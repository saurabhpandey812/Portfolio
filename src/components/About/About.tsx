    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
            Hi there! I'm Saurabh, an enthusiastic Software Engineer skilled in web development, machine learning, and scalable software solutions
          </p>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={550}>
          <div className="experience">
            ...
            <p>SRM Techsol Pvt.Ltd | January 2023 - Present</p>
            <p>Lucknow, India</p>
          </div>
        </ScrollAnimation>
      ...
      <div className="about-image">
        <ScrollAnimation animateIn="fadeInRight" delay={0.21 * 1000}>
          <img src={Saurabh} alt="Saurabh Pandey" style={{borderRadius: '50%'}} />
        </ScrollAnimation>
      </div>
    </Container>
  )
