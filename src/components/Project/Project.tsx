      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Tennis League Management</h3>
              <p>
                Tennis League Management for managing the Tennis game. Showing Leader Board, Score card, Player Profile data.
                Also Manging Playoff dataand Schedule match according the Leader board Data.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>UPDES</h3>
              <p> Developed a  UP Government website for Economics and statics using ReactJS, NodeJS, Mysql, and Context api,
                enabling users to view programming languages, cast votes, and access details through an interactive UI, leveraging serverless architecture for scalability and cost-efficiency. </p>
            </div>
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://velocityai.singh.com/" target="_blank" rel="noreferrer">
